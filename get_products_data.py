...
login_url = 'https://www.emporiorologion.gr/admin/controlloaccesso.php'
order_url = 'https://www.emporiorologion.gr/admin/ordini3.php?ordine='

input_order = input('Αριθμός Παραγγελίας: ')

order_url += input_order

creds = open('/Python/Automation/Binis/Invoice/creds.txt', 'r+').readlines()
